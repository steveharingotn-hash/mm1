...
MIDDLEMAN_ROLE_ID = 1494181899655188861
OWNER_ROLE_ID = 1494181783195877587
LOG_CHANNEL_ID = 1494218897090416720
VERIFY_ROLE_ID = 1494181537741279322
BAN_ROLE_ID = 1500871878653513758
MODLOG_CHANNEL_ID = 1494176270253293712
ADMIN_ROLE_ID = 1494182192056766464
COMMANDER_ROLE_ID = 1500156134491685055
SUPREME_LEAD_ROLE_ID = 1500156240515305606
OPERATIONS_LEAD_ROLE_ID = 1500156295804879018
CHIEF_LEAD_ROLE_ID = 1500156336795811920
TEAM_LEAD_ROLE_ID = 1500156397508100166
MANAGER_ROLE_ID = 1500156435076747325
VICE_PRESIDENT_ROLE_ID = 1500156471894216925
PRESIDENT_ROLE_ID = 1500156514663665837
HEAD_MM_ROLE_ID = 1494181947801341982
MM_MANAGER_ROLE_ID = 1494182010623627375
MODERATOR_ROLE_ID = 1494182079062085632
HEAD_MOD_ROLE_ID = 1494182134930342062
...
async def save_transcript(channel, closer, guild):
    ...
    embed.set_footer(text="Powered by RustyNickle40 MM SERVICE")  
...
VOUCH_LOG_CHANNEL_ID = 1494176269120569372  # <-- Replace with your channel ID
...
async def vouch(interaction: discord.Interaction, user: discord.Member, reason: str):
    ...
    class VouchButton(discord.ui.View):
        ...
        async def info(self, interaction2: discord.Interaction, button: discord.ui.Button):
            ...
            details_embed.set_footer(text="Powered by RustyNickle40 MM SERVICE")
...
MIDDLEMAN_ROLE_ID = 1494181899655188861 # replace with your middleman role id
...
async def verify(interaction: discord.Interaction, user: discord.Member):
    ...
    scam_embed.set_footer(text="Powered by RustyNickle40 MM SERVICE")
